...
const App: React.FC = () => {
  // 悬浮AI助手状态
  const [showFloatingAI, setShowFloatingAI] = React.useState(false);

  // 应用建议回调
  const handleApplySuggestion = (suggestion: string) => {
    // 这里可以根据当前页面类型来决定如何应用建议
    console.log('应用AI建议:', suggestion);
    // 可以通过Context或者其他方式传递给编辑器组件
  };
                  ...
                  <ErrorBoundary>
                    <AIProvider>
                      <ErrorBoundary>
                            ...
                            <div style={{ flex: 1, overflow: 'hidden' }}>
                              <div style={{ padding: '20px' }}>
                                ...
                                <Routes>
                                  ...
                                  {/* 创作工具路由匹配 */}
                                  <Route path="/project/:projectId/write" element={<WritingInterfaceOptimized />} />
                                  <Route path="/project/:projectId/creative-tools" element={<CreativeToolsPage />} />
                                  <Route path="/project/:projectId/characters" element={<CharacterManagementPage />} />
                                  <Route path="/project/:projectId/world" element={<WorldBuildingPage />} />
                        ...
                        {/* 悬浮AI助手 */}
                        <FloatingAIButton 
                          onToggleAI={() => setShowFloatingAI(!showFloatingAI)}
